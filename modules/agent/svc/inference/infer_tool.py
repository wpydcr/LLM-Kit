...
import torchaudio
import gradio as gr
from modules.agent.svc.hubert import hubert_model
import modules.agent.svc.utils as us
from modules.agent.svc.models import SynthesizerTrn
...
class Svc(object):
    def __init__(self, net_g_path, config_path, hubert_path="hubert/hubert-soft-0d54a1f4.pt",
        ...
        self.net_g_ms = None
        self.hps_ms = us.get_hparams_from_file(config_path)
        ...
        # 加载hubert
        self.hubert_soft = hubert_model.hubert_soft(model_path)
    ...
    def load_model(self):
        ...
        if self.onnx:
            ...
            self.net_g_ms = SynthesizerTrn(
                ...
                self.hps_ms.train.segment_size // self.hps_ms.data.hop_length,
                **self.hps_ms.model)
            _ = us.load_checkpoint(self.net_g_path, self.net_g_ms, None)
